...
SEXP CEmc(SEXP Proportions, SEXP IndType, SEXP PopDietType, SEXP DietToTInd, SEXP nreplicates,
         SEXP Precision)
{

int NInds, NPrey, i, j, k, x, R, Ki, TypeInd, nreps;
double Wmedio, Wmax, CWt, Wpot3, F, Si, CwS, E, PRECISION;
...
Precision = coerceVector(Precision, REALSXP);
PRECISION = REAL(Precision)[0];  // Main change
